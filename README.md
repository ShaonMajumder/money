...
add to /etc/apache2/sites-available/money.test.conf :
    ...
    <VirtualHost *:80>
        ...
        ServerAdmin admin@money.robist.test
        ServerName money.robist.test
        DocumentRoot /windows/ROBIST/Projects/money/public/
        DirectoryIndex index.php
        <Directory /windows/ROBIST/Projects/money/public/>
